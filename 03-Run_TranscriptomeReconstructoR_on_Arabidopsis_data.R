...
bam_dir <- "." # change to the folder containing Direct RNA-seq, CAGE-seq, PAT-seq and plaNET-seq BAM files produced by 01-Download_and_remap_published_Arabidopsis_datasets.sh
...
write_grl_as_bed12(long_reads, "Direct_RNAseq.bed")
